...
operacaoDesejada = input("\nEscolha a operação desejada:\n1 - Adição\n2 - Subtração\n3 - Multiplicação\n4 - Divisão")
    int(operacaoDesejada)
primeiroValorUser = input("Escolha o primeiro número:")
    # int(primeiroValorUser)
segundaValorUser = input("Escolha o segundo número:")

if operacaoDesejada == int(1) :
    resultado = int(primeiroValorUser) + int(segundaValorUser)
    print(resultado)
else :
    print("erro")
